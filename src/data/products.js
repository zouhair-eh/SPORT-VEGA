...
const generateProducts = () => {
  ...
  footballEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 200),
  ...
  gymEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 300),
  ...
  boxingEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 400),
  ...
  cardioEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 500),
  ...
  runningEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 600),
  ...
  basketballEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 700),
  ...
  tennisEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 800),
  ...
  recoveryEquipment.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 900),
  ...
  apparelItems.forEach((item, i) => {
    p.push({
      ...
      image: getProductImage(item.query, i + 1000),
